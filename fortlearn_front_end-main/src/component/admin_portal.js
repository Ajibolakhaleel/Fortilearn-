...
import AdminUsersDashboard from './adminUsers';
      ...
      <div className="row">
        ...
        <div className={`col-md-2 bg-white shadow-sm p-0 min-vh-100 position-fixed start-0 top-0 z-2 ${sidebarOpen ? 'd-block' : 'd-none'} d-md-block transition-all`} 
          ...
          <div className="list-group list-group-flush">
            ...
            <a href="#" className={`list-group-item list-group-item-action ${activeView === 'resources' ? 'active' : ''}`} onClick={() => handleNavClick('users')}>
              <i className="fas fa-boxes me-2"></i> Users
            </a>
        ...
        <div className="col-12 col-md-10 bg-light offset-md-2 px-0">
          ...
          <div className="p-2 p-md-4">
            ...
            {activeView === 'users' && <AdminUsersDashboard />}
